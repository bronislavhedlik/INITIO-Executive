...
| Brand Complete Lock | `Historical Fact` / `Conflict` | Chat tvrdí COMPLETE LOCK; brand repository má pouze symbol a chybějící Brand Constitution | Reconcile s aktuální brand repository reality. |
| BH OS architecture/governance/roles | `Historical Fact` | Chatové LOCKy; současnou implementaci určují BH_OS a bh-os-clean | Ověřit proti aktuálním kanonickým artefaktům a repository reality. |
